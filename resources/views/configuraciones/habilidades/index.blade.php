...
<!-- Modal -->
<div class="modal fade" id="modalHabilidad" tabindex="-1" aria-labelledby="miModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="miModalLabel">Título del modal</h5>
                <a type="button" data-bs-dismiss="modal" aria-label="Close" onclick='$("#modalHabilidad").modal("hide")'><i
...
<script>
    ...
    async function abrirModal(editar = false) {
        ...
        $("#formularioHabilidad").attr("action", ruta);
        $("#modalHabilidad").modal();
    }


    async function getDatosTipos(id) {
        try {
            let ruta = "{{ route('getDataHabilidad', '_id_') }} ";
    ...
    function guardar() {
        let ruta = $("#formularioHabilidad").attr("action");
